...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='saida/grafo_treinado.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='arquivos_intermediarios/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='saida/grafo_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='arquivos_intermediarios/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='arquivos_intermediarios/bottleneck',
  ...
  parser.add_argument(
      '--checkpoint_path',
      type=str,
      default='arquivos_intermediarios/_retrain_checkpoint',
